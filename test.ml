    ...
    ("Board" >::: [
      ".wins" >::: [
        "is false for empty" >:: (fun() ->
          Board.empty |> Board.wins Piece.A |> assert_equal false
        );
        "is false for vertical line of 3" >:: (fun() ->
          Board.build [
            ...
            "A------";
            "A------"]
            |> Board.wins Piece.A |> assert_equal false
        );
        "is true for vertical line of 4" >:: (fun() ->
          Board.build [
            ...
            "A------";
            "A------"]
          |> Board.wins Piece.A |> assert_equal true
        );
        ...
        "is false when there is a gap in the line" >:: (fun() ->
          Board.build [
            ...
            "--AAA--";
            "B-AAA--"]
          |> Board.wins Piece.B |> assert_equal false
        );
      ];
      (".to_string" >::: [
